...
import { Loading, BottomNavigation } from 'components/index';
import { Fade } from 'components/transitions/index';
import { Login, Upload, Feed, Profile } from 'containers/index';
...
export default () => {
  ...
  return (
    <div id="App" className="text-grey-darkest">
      <Router>
        <div className="flex flex-col h-screen w-full">
          <div className="h-0 flex-auto w-full overflow-y-auto">
            {loading ? (
